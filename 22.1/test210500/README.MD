...
You can Just deploy the file "com.example.test210500-1.0-SNAPSHOT.zip" on your development environment.  (The development environment for Angular (22.x) is not yet available on https://developers.bmc.com/site/global/home/index.gsp).  
https://docs.bmc.com/docs/is221/deploying-your-digital-service-application-for-the-first-time-to-start-working-in-bmc-helix-innovation-studio-1039589996.html?src=search 
...
* https://docs.bmc.com/docs/is221/setting-up-your-ide-and-installing-bmc-helix-innovation-studio-sdk-1039589980.html?src=search
* You will need nodeJs, maven, Yarn, Grunt and Java (OpenJDK).  


To deploy:
* https://docs.bmc.com/docs/is221/creating-a-project-using-maven-and-the-archetype-1039589994.html?src=search
* https://docs.bmc.com/docs/is221/deploying-your-digital-service-application-for-the-first-time-to-start-working-in-bmc-helix-innovation-studio-1039589996.html?src=search 
