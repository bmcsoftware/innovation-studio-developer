...
public class AttachFile implements Service {
     ...
     * @param base64Payload        (String) The file, in base64 format.
     * @return boolean, a boolean that will tell if the signature has been successfully attached.
     */
    @Action(name = "createAttachmentFromBase64File", scope = Scope.PUBLIC)
    public boolean createAttachmentFromBase64File(@ActionParameter(name = "recordDefinitionName") @NotBlank @NotNull String recordDefinitionName,
