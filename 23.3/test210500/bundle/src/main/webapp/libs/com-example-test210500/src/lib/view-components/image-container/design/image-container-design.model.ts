...
import { IImageContainerParameters } from './image-container.interface';

// View component input parameters.
const initialComponentProperties: IImageContainerParameters = {
  styles: '',
  hidden: ''
};

export class ImageContainerDesignModel extends ViewDesignerComponentModel implements IViewDesignerComponentModel {
  constructor(protected injector: Injector,
    ...
    combineLatest([this.sandbox.componentProperties$])
      .pipe(
        map(([componentProperties]: [IImageContainerParameters]) =>
  ...
  static getInitialProperties(initialProperties?: IImageContainerParameters): IImageContainerParameters {
  ...
  private setInspectorConfig(model : IImageContainerParameters) {
    return {
  ...
  private validate(
    ...
    model: IImageContainerParameters
  ): IViewComponentDesignValidationIssue[] {
