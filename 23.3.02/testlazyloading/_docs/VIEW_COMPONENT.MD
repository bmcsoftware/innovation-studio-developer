...
You can see the differences in the commit []().
...
> :memo:  
> We do not need to implement the hidden property as we set in the view component the isHidden property of the BaseComponent.
